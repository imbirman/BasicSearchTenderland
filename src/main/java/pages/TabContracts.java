...
public class TabContracts extends PageObject {
    ...
    protected By buttonValidateSearchByContractExecutionStartDate = By.xpath("//div[text()='Проверка поиска по дате начала исполнения']"); // Кнопка автопоиска "Проверка поиска по дате начала исполнения"
    protected By buttonValidateSearchByContractExecutionEndDate = By.xpath("//div[text()='Проверка поиска по дате окончания исполнения']"); // Кнопка автопоиска "Проверка поиска по дате окончания исполнения"
    protected By buttonValidateSearchByContractActualExecutionDate = By.xpath("//div[text()='Проверка поиска по фактической дате исполнения']"); // Кнопка автопоиска "Проверка поиска по фактической дате исполнения"
    protected By buttonValidateSearchByContractDateOfSigning = By.xpath("//div[text()='Проверка поиска по дате подписания']"); // Кнопка автопоиска "Проверка поиска по дате подписания"
    protected By buttonCheckSearchByMulct = By.xpath("//div[text()='Проверка поиска по штрафу']"); // Кнопка автопоиска "Проверка поиска по штрафу"
